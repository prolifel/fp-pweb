...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-success">
        ...
        <div class="login-content" >
                ...
                <form action="register.php" method="post" onsubmit="return checkPassword(this);" enctype="multipart/form-data">
                <div class="card-header">
                    <h3>Register Sebagai Murid</h3>
                </div>
                ...
                <label class="form-reg">
                    <p class="label-txt">Verifikasi Wajah</p>
                    <br>
                ...
                <label class="form-reg">
                    <p class="label-txt">Kelas</p>
                    <br>
                    <select class="form-control" name="kelas">
                        <?php
                            include "../koneksi.php";

                            $query = mysqli_query($koneksi, "select nama from kelas");
                ...
                <div class="form-reg" hidden>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="role" id="inlineRadio1" value="murid" checked>
                        <label class="form-check-label" for="inlineRadio1">Murid</label>
                    </div>
                </div>
                <br>
                <button type="submit" class="btn btn-warning" value="Upload Image" name="submit">Register</button>
            </form>
        </div>
        </div>
